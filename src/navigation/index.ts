...
export const getHeaderData = (pathname: string) =>
  detectLocale(pathname) === 'en' ? headerDataEn : headerDataZh;

export const getFooterData = (pathname: string) =>
  detectLocale(pathname) === 'en' ? footerDataEn : footerDataZh;
